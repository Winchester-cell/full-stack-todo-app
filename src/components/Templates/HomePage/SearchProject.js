...
export default function SearchProject() {
    ...
    return (
        <div className='bg-[var(--colorB)] w-[calc(100%-155px)] lg:w-[350px] rounded-full p-1 shadow-lg'>
            <div className='rounded-full shadow-inner flex gap-2 items-center justify-center bg-[var(--colorA)] py-2 lg:py-3 ps-4 lg:ps-7 pe-5'>
                <FaSearch className='text-[var(--colorTextB)]' />
                <input onChange={onChangeHanlder} placeholder={'Search ...'} type="text" className='block w-full text-[12px] lg:text-[14px] placeholder:text-[12px] lg:placeholder:text-[14px]' />
            </div>
        </div>
    )
}
